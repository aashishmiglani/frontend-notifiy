...
// ✅ Extracted SearchInput to prevent cursor jump
            ...
            return (
              ...
              >
                ...
                <div className="flex space-x-2">
                  <button onClick={(e) => { e.stopPropagation(); handleEdit(ev); }} className="flex-1 bg-gray-400 hover:bg-gray-500 text-white px-3 py-2 rounded-xl text-xs">Edit</button>
                  <button onClick={(e) => { e.stopPropagation(); handleDelete(ev.id); }} className="flex-1 bg-gray-500 hover:bg-gray-600 text-white px-3 py-2 rounded-xl text-xs">Delete</button>
                </div>
              </div>
            );
          })
